...
class CheckedSelect extends React.Component {
    ...
    constructor(props, context) {
        super(props, context);
        let options = this.props.async ? [] : this.props.options;
        let val =  this.filterValueByOptions(this.props.value, this.props.options);

        this.markSelectedOptions = this.markSelectedOptions.bind(this);
        this.toggleSelection = this.toggleSelection.bind(this);
        this.clearIsSelectedFlags = this.clearIsSelectedFlags.bind(this);
